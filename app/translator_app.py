...
# -----------------------------
st.markdown("---")
st.header(tr("📈 Ejecutar BasinCast + Visualizar (v0.13)", "📈 Run BasinCast Core + Visualize (v0.13)", LANG))
...
with c3:
    run_outdir = Path(st.text_input(tr("Carpeta outputs", "Run output folder", LANG), value="outputs"))
